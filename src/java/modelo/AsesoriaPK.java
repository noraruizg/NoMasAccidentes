...
public class AsesoriaPK implements Serializable {
    ...
    public AsesoriaPK(BigInteger idAsesoria, BigInteger extraIdSolicitudes, BigInteger extraContratoIdContrato, BigInteger extraContClienteIdCliente, BigInteger extraContCliUsIdUsuario, BigInteger idVisita, BigInteger idProfesional2, BigInteger idProfesional11) {
    ...
    public BigInteger getIdAsesoria() {
        return idAsesoria;
    }

    public void setIdAsesoria(BigInteger idAsesoria) {
        this.idAsesoria = idAsesoria;
    }
